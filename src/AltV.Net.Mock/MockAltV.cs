...
namespace AltV.Net.Mock
{
    ...
    public class MockAltV<TPlayer, TVehicle, TBlip, TCheckpoint, TVoiceChannel> where TPlayer : IPlayer
        ...
        where TVoiceChannel : IVoiceChannel
    {
        public MockAltV(string entryPoint)
        {
            ...
            var baseObjectPool =
                new MockBaseBaseObjectPool(playerPool, vehiclePool, blipPool, checkpointPool, voiceChannelPool);
