            ...
            return (
                ...
                (i = function(b, c, e, f) {
                    ...
                    return (
                        ...
                        (i = function() {
                            return 2 === f && e.indexOf('-') > -1
                                ? k(c, e, f + 1)
                                : d.fallback && d.fallback !== e
                                  ? k(c, d.fallback)
                                  : void 0;
                        }),
                        (g = {
                            url: b + "?t=" + $("body").attr("data-timestamp"),
                            dataType: 'json',
                            async: !0,
                        ...
                        b.is('input')
                            ...
                            : b.is('textarea')
                              ...
                              : b.is('img')
                                ...
                                : b.is('optgroup')
                                  ? p(b, c, d)
                                  : a.isPlainObject(d) || b.html(d),
                        a.isPlainObject(d) ? m(b, d) : void 0
                    );
                }),
                (o = function(b, c, d) {
                    var e;
                    return (
                        (e = a.isPlainObject(d) ? d.value : d),
                        b.is('[placeholder]')
                            ? b.attr('placeholder', e)
                            : b.val(e)
                    );
                }),
                (m = function(a, b) {
                ...
                (u = function(a, b) {
                    var c, d, e, f;
                    for (
                        c = a.split(/\./), d = b, e = 0, f = c.length;
                        f > e;
                        e++
                    )
                        (a = c[e]), (d = null != d ? d[a] : null);
                    return d;
                }),
                (s = function(a, b, c) {
                ...
                d.skipLanguage && j.match(r(d.skipLanguage))
                    ? f.resolve()
                    : k(c, j, 1),
                (v.localizePromise = f),
                v
