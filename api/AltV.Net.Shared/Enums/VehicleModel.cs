namespace AltV.Net.Enums
{
    public enum VehicleModel : uint
    {
        ...
        trailers5 = 2960513480, // [0xB075D9C8] Trailer (TRAILER)
        aleutian = 4256087847, // [0xFDAEBF27] Aleutian (CAR)
        freight2 = 3852738056, // [0xE5A41E08] Freight Train (TRAIN)
        tvtrailer2 = 471034616, // [0x1C136AF8] Trailer (TRAILER)
        vivanite = 2922168362, // [0xAE2CC02A] Vivanite (CAR)
        baller8 = 3431608412, // [0xCC8A305C] Baller ST-D (CAR)
        benson2 = 728350375, // [0x2B69BEA7] Benson (Cluckin' Bell) (CAR)
        towtruck4 = 3392937977, // [0xCA3C1FF9] Tow Truck (CAR)
        driftremus = 2670883828, // [0x9F3273F4] Remus (CAR)
        cavalcade3 = 3265236814, // [0xC29F8F4E] Cavalcade XL (CAR)
        boattrailer3 = 1539159908, // [0x5BBDB764] Boat Trailer (TRAILER)
        driftfr36 = 2815031719, // [0xA7C9F9A7] FR36 (CAR)
        drifteuros = 821121576, // [0x30F15228] Euros (CAR)
        dorado = 3526923154, // [0xD2389392] Dorado (CAR)
        towtruck3 = 3623402354, // [0xD7F8BB72] Tow Truck (CAR)
        terminus = 167522317, // [0x9FC300D] Terminus (CAR)
        boattrailer2 = 1835260592, // [0x6D63DAB0] Boat Trailer (TRAILER)
        driftyosemite = 2613313775, // [0x9BC400EF] Drift Yosemite (CAR)
        police5 = 2620582743, // [0x9C32EB57] Stanier LE Cruiser (CAR)
        turismo3 = 4171974011, // [0xF8AB457B] Turismo Omaggio (CAR)
        dominator9 = 3853757601, // [0xE5B3ACA1] Dominator GT (CAR)
        fr36 = 3829141989, // [0xE43C11E5] FR36 (CAR)
        driftjester = 2531693357, // [0x96E6932D] Jester RR (CAR)
        impaler6 = 4116524922, // [0xF55D2F7A] Impaler LX (CAR)
        impaler5 = 3816328113, // [0xE3788BB1] Impaler SZ (CAR)
        polgauntlet = 3061199846, // [0xB67633E6] Gauntlet Interceptor (CAR)
        boxville6 = 3452201761, // [0xCDC46B21] Boxville (LSDS) (CAR)
        Phantom4 = 4165683409, // [0xF84B48D1] Phantom (CAR)
        vigero3 = 372621319, // [0x1635C007] Vigero ZX Convertible (CAR)
