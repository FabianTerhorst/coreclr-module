...
namespace AltV.Net.Mock
{
    ...
    public class MockAltV<TPlayer, TVehicle, TPed, TNetworkObject, TBlip, TCheckpoint, TVoiceChannel, TColShape, TVirtualEntity, TVirtualEntityGroup, TMarker> where TPlayer : IPlayer
    ...
    where TColShape: IColShape
    {
        ...
        public MockAltV(string entryPoint)
        {
            ...
            var baseObjectPool =
                new MockPoolManager(playerPool, vehiclePool, pedPool, networkObjectPool, blipPool, checkpointPool, voiceChannelPool, colShapePool, virtualEntityPool, virtualEntityGroupPool,markerPool);
