...
namespace AltV.Net.Async
{
    public static partial class AltAsync
    {
        public static Function OnServer(string eventName, Action action) =>
            Core.OnServer(eventName, Function.Create(Core, action));
        ...
        public static Function OnServer<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Action<T1, T2, T3, T4, T5, T6, T7> action) => Core.OnServer(eventName, Function.Create(Core, action));

        public static Function OnServer<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Action<T1, T2, T3, T4, T5, T6, T7, T8> action) => Core.OnServer(eventName, Function.Create(Core, action));
        ...
        public static Function OnServer<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Func<T1, T2, T3, T4, T5, T6, T7> action) => Core.OnServer(eventName, Function.Create(Core, action));

        public static Function OnServer<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Func<T1, T2, T3, T4, T5, T6, T7, T8> action) => Core.OnServer(eventName, Function.Create(Core, action));
        ...
        public static Function OnClient(string eventName, Action action) =>
            Core.OnClient(eventName, Function.Create(Core, action));
        ...
        public static Function OnClient<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Action<T1, T2, T3, T4, T5, T6, T7> action) => Core.OnClient(eventName, Function.Create(Core, action));

        public static Function OnClient<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Action<T1, T2, T3, T4, T5, T6, T7, T8> action) => Core.OnClient(eventName, Function.Create(Core, action));
        ...
        public static Function OnClient<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Func<T1, T2, T3, T4, T5, T6, T7> action) => Core.OnClient(eventName, Function.Create(Core, action));

        public static Function OnClient<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Func<T1, T2, T3, T4, T5, T6, T7, T8> action) => Core.OnClient(eventName, Function.Create(Core, action));
