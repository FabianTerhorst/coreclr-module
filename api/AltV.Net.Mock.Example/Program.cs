...
namespace AltV.Net.Mock.Example
{
    class Program
    {
        ...
        {
            var mockAltV =
                new MockAltV<IPlayer, IMyVehicle, IPed, INetworkObject, IBlip, ICheckpoint, IVoiceChannel, IColShape, IVirtualEntity, IVirtualEntityGroup, IMarker>("resource/AltV.Net.Example.dll");
