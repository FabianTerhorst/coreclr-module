...
namespace AltV.Net.EntitySync.SpatialPartitions
{
        ...
        IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue> where TKey : notnull
    {
        ...
        {
            private SortedLimitedList<TKey, TValue> _sortedList;
        ...
        private sealed class SortedListValueEnumerator : IEnumerator<TValue>, IEnumerator
        {
            ...
            internal SortedListValueEnumerator(SortedLimitedList<TKey, TValue> sortedList)
            {
                _sortedList = sortedList;
                _version = sortedList.version;
            }
        ...
        public sealed class KeyList : IList<TKey>, ICollection
        {
            ...
            internal KeyList(SortedLimitedList<TKey, TValue> dictionary)
            {
                _dict = dictionary;
            }
        ...
        public sealed class ValueList : IList<TValue>, ICollection
        {
            ...
            public int Count
            {
                get { return Math.Min(_dict._size, _dict.maxSize); }
            }
