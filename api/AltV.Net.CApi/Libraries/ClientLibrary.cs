...
namespace AltV.Net.CApi.Libraries
{
    ...
    public unsafe class ClientLibrary : IClientLibrary
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate nint Core_Client_CreateAreaBlipDelegate(nint _core, Vector3 _position, float _width, float _height);
        private static nint Core_Client_CreateAreaBlipFallback(nint _core, Vector3 _position, float _width, float _height) => throw new Exceptions.OutdatedSdkException("Core_Client_CreateAreaBlip", "Core_Client_CreateAreaBlip SDK method is outdated. Please update your module nuget");
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate nint Core_Client_CreatePointBlipDelegate(nint _core, Vector3 _position);
        private static nint Core_Client_CreatePointBlipFallback(nint _core, Vector3 _position) => throw new Exceptions.OutdatedSdkException("Core_Client_CreatePointBlip", "Core_Client_CreatePointBlip SDK method is outdated. Please update your module nuget");
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate nint Core_Client_CreateRadiusBlipDelegate(nint _core, Vector3 _position, float _radius);
        private static nint Core_Client_CreateRadiusBlipFallback(nint _core, Vector3 _position, float _radius) => throw new Exceptions.OutdatedSdkException("Core_Client_CreateRadiusBlip", "Core_Client_CreateRadiusBlip SDK method is outdated. Please update your module nuget");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate nint Core_CreateCheckpointDelegate(nint _server, byte _type, Vector3 _pos, Vector3 _nextPos, float _radius, float _height, Rgba _color);
        private static nint Core_CreateCheckpointFallback(nint _server, byte _type, Vector3 _pos, Vector3 _nextPos, float _radius, float _height, Rgba _color) => throw new Exceptions.OutdatedSdkException("Core_CreateCheckpoint", "Core_CreateCheckpoint SDK method is outdated. Please update your module nuget");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate nint Core_CreateObjectDelegate(nint _core, uint _modelHash, Vector3 _position, Vector3 _rot, byte _noOffset, byte _dynamic);
        private static nint Core_CreateObjectFallback(nint _core, uint _modelHash, Vector3 _position, Vector3 _rot, byte _noOffset, byte _dynamic) => throw new Exceptions.OutdatedSdkException("Core_CreateObject", "Core_CreateObject SDK method is outdated. Please update your module nuget");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate ushort Vehicle_GetGearDelegate(nint _vehicle);
        private static ushort Vehicle_GetGearFallback(nint _vehicle) => throw new Exceptions.OutdatedSdkException("Vehicle_GetGear", "Vehicle_GetGear SDK method is outdated. Please update your module nuget");
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate byte Vehicle_GetIndicatorLightsDelegate(nint _vehicle);
        private static byte Vehicle_GetIndicatorLightsFallback(nint _vehicle) => throw new Exceptions.OutdatedSdkException("Vehicle_GetIndicatorLights", "Vehicle_GetIndicatorLights SDK method is outdated. Please update your module nuget");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate float Vehicle_GetRPMDelegate(nint _vehicle);
        private static float Vehicle_GetRPMFallback(nint _vehicle) => throw new Exceptions.OutdatedSdkException("Vehicle_GetRPM", "Vehicle_GetRPM SDK method is outdated. Please update your module nuget");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate void Vehicle_SetGearDelegate(nint _vehicle, ushort _value);
        private static void Vehicle_SetGearFallback(nint _vehicle, ushort _value) => throw new Exceptions.OutdatedSdkException("Vehicle_SetGear", "Vehicle_SetGear SDK method is outdated. Please update your module nuget");
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate void Vehicle_SetIndicatorLightsDelegate(nint _vehicle, byte _value);
        private static void Vehicle_SetIndicatorLightsFallback(nint _vehicle, byte _value) => throw new Exceptions.OutdatedSdkException("Vehicle_SetIndicatorLights", "Vehicle_SetIndicatorLights SDK method is outdated. Please update your module nuget");
        ...
        public ClientLibrary(Dictionary<ulong, IntPtr> funcTable)
        {
            ...
            else if (capiHash == IntPtr.Zero || *(ulong*)capiHash != 11952429092119126951UL) Outdated = true;
            ...
            Core_Client_CreateAreaBlip = (delegate* unmanaged[Cdecl]<nint, Vector3, float, float, nint>) GetUnmanagedPtr<Core_Client_CreateAreaBlipDelegate>(funcTable, 413335305575119259UL, Core_Client_CreateAreaBlipFallback);
            Core_Client_CreatePointBlip = (delegate* unmanaged[Cdecl]<nint, Vector3, nint>) GetUnmanagedPtr<Core_Client_CreatePointBlipDelegate>(funcTable, 3821343639476160130UL, Core_Client_CreatePointBlipFallback);
            Core_Client_CreateRadiusBlip = (delegate* unmanaged[Cdecl]<nint, Vector3, float, nint>) GetUnmanagedPtr<Core_Client_CreateRadiusBlipDelegate>(funcTable, 15268539024886688517UL, Core_Client_CreateRadiusBlipFallback);
            ...
            Core_CreateCheckpoint = (delegate* unmanaged[Cdecl]<nint, byte, Vector3, Vector3, float, float, Rgba, nint>) GetUnmanagedPtr<Core_CreateCheckpointDelegate>(funcTable, 18356657226389300272UL, Core_CreateCheckpointFallback);
            ...
            Core_CreateObject = (delegate* unmanaged[Cdecl]<nint, uint, Vector3, Vector3, byte, byte, nint>) GetUnmanagedPtr<Core_CreateObjectDelegate>(funcTable, 6433769288578077423UL, Core_CreateObjectFallback);
            ...
            Vehicle_GetGear = (delegate* unmanaged[Cdecl]<nint, ushort>) GetUnmanagedPtr<Vehicle_GetGearDelegate>(funcTable, 14856980452477515065UL, Vehicle_GetGearFallback);
            Vehicle_GetIndicatorLights = (delegate* unmanaged[Cdecl]<nint, byte>) GetUnmanagedPtr<Vehicle_GetIndicatorLightsDelegate>(funcTable, 5904569975238952717UL, Vehicle_GetIndicatorLightsFallback);
            ...
            Vehicle_GetRPM = (delegate* unmanaged[Cdecl]<nint, float>) GetUnmanagedPtr<Vehicle_GetRPMDelegate>(funcTable, 4747067744469979127UL, Vehicle_GetRPMFallback);
            ...
            Vehicle_SetGear = (delegate* unmanaged[Cdecl]<nint, ushort, void>) GetUnmanagedPtr<Vehicle_SetGearDelegate>(funcTable, 17703497274433712812UL, Vehicle_SetGearFallback);
            Vehicle_SetIndicatorLights = (delegate* unmanaged[Cdecl]<nint, byte, void>) GetUnmanagedPtr<Vehicle_SetIndicatorLightsDelegate>(funcTable, 5334309954273669360UL, Vehicle_SetIndicatorLightsFallback);
