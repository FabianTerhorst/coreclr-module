...
namespace AltV.Net
{
    ...
    {
        [Obsolete("This method is obsolete. Use Alt.OffServer or Alt.OffClient instead.")]
        public static void Off(string eventName, Function function) => Module.Off(eventName, function);

        [Obsolete("This method is obsolete. Use Alt.OffClient instead.")]
        ...
        [Obsolete("This method is obsolete. Use Alt.OffServer instead.")]
