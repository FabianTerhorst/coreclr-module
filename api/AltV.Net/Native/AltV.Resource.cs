...
namespace AltV.Net.Native
{
    internal static partial class AltNative
    {
        ...
        internal static class Resource
        {
            ...
            internal delegate void PlayerBeforeConnectDelegate(IntPtr eventPointer, IntPtr playerPointer, ushort playerId, ulong passwordHash, string cdnUrl, string reason);
