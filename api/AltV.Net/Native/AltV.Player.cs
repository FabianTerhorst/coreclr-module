...
namespace AltV.Net.Native
{
    internal static partial class AltNative
    {
        ...
        internal static class Player
        {
            ...
            [DllImport(DllName, CallingConvention = NativeCallingConvention)]
            internal static extern bool Player_AttachToEntity(IntPtr player, IntPtr entity, ushort otherBone, ushort ownBone, Position pos, Rotation rot, bool collision, bool noFixedRot);
