...
EXPORT_CLIENT uint32_t RmlElement_GetChildCount(alt::IRmlElement* rmlElement);
EXPORT_CLIENT void RmlElement_GetChildNodes(alt::IRmlElement* rmlElement, alt::IRmlElement**& arr, uint32_t& size);
...
EXPORT_CLIENT alt::IRmlElement* RmlElement_GetLastChild(alt::IRmlElement* rmlElement);
EXPORT_CLIENT alt::IRmlElement* RmlElement_GetNextSibling(alt::IRmlElement* rmlElement);
EXPORT_CLIENT alt::IRmlElement* RmlElement_GetPreviousSibling(alt::IRmlElement* rmlElement);
...
EXPORT_CLIENT alt::IRmlDocument* RmlElement_GetOwnerDocument(alt::IRmlElement* rmlElement);
...
EXPORT_CLIENT alt::IRmlElement* RmlElement_GetClosest(alt::IRmlElement* rmlElement, const char* selectors);
...
EXPORT_CLIENT void RmlElement_GetAttributes(alt::IRmlElement* rmlElement, const char**& keys, const char**& values, uint32_t& size);
EXPORT_CLIENT void RmlElement_GetClassList(alt::IRmlElement* rmlElement, const char**& classes, uint32_t& size);
EXPORT_CLIENT alt::IRmlElement* RmlElement_GetElementById(alt::IRmlElement* rmlElement, const char* id);
EXPORT_CLIENT void RmlElement_GetElementsByClassName(alt::IRmlElement* rmlElement, const char* className, alt::IRmlElement**& arr, uint32_t& size);
EXPORT_CLIENT void RmlElement_GetElementsByTagName(alt::IRmlElement* rmlElement, const char* tagName, alt::IRmlElement**& arr, uint32_t& size);
...
EXPORT_CLIENT void RmlElement_GetPseudoClassList(alt::IRmlElement* rmlElement, const char**& classes, uint32_t& size);
...
EXPORT_CLIENT void RmlElement_QuerySelectorAll(alt::IRmlElement* rmlElement, const char* selector, alt::IRmlElement**& arr, uint32_t& size);
...
EXPORT_CLIENT void RmlElement_SetOffset(alt::IRmlElement* rmlElement, alt::IRmlElement* element, vector2_t offset, uint8_t fixed);
