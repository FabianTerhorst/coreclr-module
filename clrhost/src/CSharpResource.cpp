    ...
    : alt::IResource(info)
{
    ...
    coreClr->GetDelegate(server, runtimeHost, domainId, /*main.CStr()*/ "AltV.Net", "AltV.Net.Module", "Main", reinterpret_cast<void **>(&MainDelegate));
    coreClr->GetDelegate(server, runtimeHost, domainId, /*main.CStr()*/ "AltV.Net", "AltV.Net.Module", "OnPlayerConnect", reinterpret_cast<void **>(&OnPlayerConnectDelegate));
    coreClr->GetDelegate(server, runtimeHost, domainId, /*main.CStr()*/ "AltV.Net", "AltV.Net.Module", "OnPlayerDisconnect", reinterpret_cast<void **>(&OnPlayerDisconnectDelegate));
}
